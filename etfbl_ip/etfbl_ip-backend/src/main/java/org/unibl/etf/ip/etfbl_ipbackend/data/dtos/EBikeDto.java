...
public class EBikeDto implements Serializable {
    ...
    public EBikeDto(Integer id, Integer vehicleId, String vehicleUid, BigDecimal vehiclePurchasePrice, String vehicleModel, Integer vehicleManufacturerId, String vehicleManufacturerName, String vehicleManufacturerCountry, VehicleStatus vehicleStatus, BigDecimal vehiclePricePerSecond, BigDecimal vehicleX, BigDecimal vehicleY, Integer autonomy) {
        this.id = id;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, vehicleId, vehicleUid, vehiclePurchasePrice, vehicleModel, vehicleManufacturerId, vehicleManufacturerName, vehicleManufacturerCountry, vehicleStatus, vehiclePricePerSecond, vehicleX, vehicleY, autonomy);
    }
