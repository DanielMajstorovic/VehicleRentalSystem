 ...
 */
public class CreateManufacturerDto implements Serializable {
    @Size(max = 75)
    ...
    public CreateManufacturerDto(String name, String country, String address, String phone, String fax, String email) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        CreateManufacturerDto entity = (CreateManufacturerDto) o;
