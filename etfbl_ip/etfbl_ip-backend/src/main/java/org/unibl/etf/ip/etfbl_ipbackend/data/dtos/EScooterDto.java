 ...
 */
public class EScooterDto implements Serializable {
    private Integer id;
    ...
    public EScooterDto(Integer id, Integer vehicleId, String vehicleUid, BigDecimal vehiclePurchasePrice, String vehicleModel, Integer vehicleManufacturerId, String vehicleManufacturerName, String vehicleManufacturerCountry, VehicleStatus vehicleStatus, BigDecimal vehiclePricePerSecond, BigDecimal vehicleX, BigDecimal vehicleY, Integer maxSpeed) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        EScooterDto entity = (EScooterDto) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, vehicleId, vehicleUid, vehiclePurchasePrice, vehicleModel, vehicleManufacturerId, vehicleManufacturerName, vehicleManufacturerCountry, vehicleStatus, vehiclePricePerSecond, vehicleX, vehicleY, maxSpeed);
    }
