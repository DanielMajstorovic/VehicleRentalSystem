...
@Component({
  selector: 'app-car-details-manager',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './car-details-manager.component.html',
  styleUrl: './car-details-manager.component.scss'
})
export class CarDetailsManagerComponent implements OnInit, AfterViewInit {
  carId!: number;
  ...
  onBackToCars() {
    this.router.navigate(['/manager/cars-manager']);
  }
}
