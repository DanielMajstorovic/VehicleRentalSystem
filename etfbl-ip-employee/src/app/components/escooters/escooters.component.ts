...
@Component({
  selector: 'app-escooters',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, FormsModule],
  templateUrl: './escooters.component.html',
  styleUrls: ['./escooters.component.scss'],
})
export class EscootersComponent implements OnInit, AfterViewInit {
  ...
  onViewDetails(sc: EScooterDto) {
    this.router.navigate(['/administrator/escooter-details', sc.id]);
  }
