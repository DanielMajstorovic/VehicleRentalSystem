...
@Component({
  selector: 'app-escooter-details',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './escooter-details.component.html',
  styleUrls: ['./escooter-details.component.scss'],
})
export class EscooterDetailsComponent implements OnInit, AfterViewInit {
  scooterId!: number;
  ...
  onBack() {
    this.router.navigate(['/administrator/escooters']);
  }
}
