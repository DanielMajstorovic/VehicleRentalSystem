...
@WebServlet("/car")
public class CarRentalServlet extends AbstractRentalServlet {
    ...
    @Override protected void doGet(HttpServletRequest req,HttpServletResponse resp)
        ...
        try {
            ...
            List<Vehicle> cars = new VehicleDao().listAvailableCars();
            req.setAttribute("cars",cars);
            req.getRequestDispatcher("/WEB-INF/views/car_rental.jsp").forward(req,resp);
    ...
    @Override protected void doPost(HttpServletRequest req,HttpServletResponse resp)
        ...
        try{
            int rentalId = new RentalDao().createRental(r);
